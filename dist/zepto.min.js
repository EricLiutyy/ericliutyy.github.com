...
var Zepto = function() {
  function t(t) {
    return null == t ? t + "" : J[U.call(t)] || "object"
  }
  function n(n) {
    return "function" == t(n)
  }
  ...
  function l(t) {
    return t in Z ? Z[t] : Z[t] = RegExp("(^|\\s)" + t + "(\\s|$)")
  }
  function f(t, n) {
  ...
  function h(t) {
    var n, e;
    return P[t] || (n = L.createElement(t),
  ...
  function p(t) {
    return "children"in t ? A.call(t.children) : x.map(t.childNodes, function(t) {
      return 1 == t.nodeType ? t : N
    })
  }
  function d(t, n, e) {
    for (E in n)
      e && (o(n[E]) || G(n[E])) ? (o(n[E]) && !o(t[E]) && (t[E] = {}),
      G(n[E]) && !G(t[E]) && (t[E] = []),
        d(t[E], n[E], e)) : n[E] !== N && (t[E] = n[E])
  }
  function m(t, n) {
  ...
  function y(t, n) {
    var e = t.className || ""
      , i = e && e.baseVal !== N;
    return n === N ? i ? e.baseVal : e : (i ? e.baseVal = n : t.className = n,
      N)
  }
  function b(t) {
    var n;
  ...
  function w(t, n) {
    n(t);
    for (var e = 0, i = t.childNodes.length; i > e; e++)
      w(t.childNodes[e], n)
  }
  var N, E, x, C, O, T, S = [], A = S.slice, $ = S.filter, L = window.document, P = {}, Z = {}, j = {
      "column-count": 1,
      columns: 1,
      "font-weight": 1,
      "line-height": 1,
      ...
      "z-index": 1,
      zoom: 1
    }, M = /^\s*<(\w+|!)[^>]*>/, q = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, z = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, k = /^(?:body|html)$/i, B = /([A-Z])/g, R = ["val", "css", "html", "text", "data", "width", "height", "offset"], V = ["after", "prepend", "before", "append"], _ = L.createElement("table"), F = L.createElement("tr"), H = {
      ...
      th: F,
      "*": L.createElement("div")
    }, D = /complete|loaded|interactive/, I = /^[\w-]*$/, J = {}, U = J.toString, W = {}, X = L.createElement("div"), Y = {
      tabindex: "tabIndex",
      readonly: "readOnly",
      "for": "htmlFor",
      "class": "className",
  ...
  return W.matches = function(t, n) {
    ...
    W.fragment = function(t, n, e) {
      ...
      n === N && (n = M.test(t) && RegExp.$1),
      n in H || (n = "*"),
        s = H[n],
        s.innerHTML = "" + t,
        i = x.each(A.call(s.childNodes), function() {
          s.removeChild(this)
        })),
      o(e) && (r = x(i),
    ...
    W.init = function(t, e) {
      ...
      if ("string" == typeof t)
        ...
        if (G(t))
          ...
          i = W.fragment(t.trim(), RegExp.$1, e),
            t = null ;
        else {
          if (e !== N)
            return x(e).find(t);
    ...
    ,
    W.qsa = function(t, n) {
      var e, r = "#" == n[0], o = !r && "." == n[0], s = r || o ? n.slice(1) : n, u = I.test(s);
    ...
    ,
    x.contains = L.documentElement.contains ? function(t, n) {
  ...
  window.JSON && (x.parseJSON = JSON.parse),
    x.each("Boolean Number String Function Array Date RegExp Object Error".split(" "), function(t, n) {
    ...
    x.fn = {
      ...
      concat: S.concat,
      map: function(t) {
        return x(x.map(this, function(n, e) {
          return t.call(n, e, n)
        }))
      },
      slice: function() {
      ...
      ready: function(t) {
        return D.test(L.readyState) && L.body ? t(x) : L.addEventListener("DOMContentLoaded", function() {
          t(x)
        }, !1),
          this
      },
      ...
      each: function(t) {
        return S.every.call(this, function(n, e) {
          return t.call(n, e, n) !== !1
        }),
          this
      },
      filter: function(t) {
        return n(t) ? this.not(this.not(t)) : x($.call(this, function(n) {
          return W.matches(n, t)
        }))
      },
      add: function(t, n) {
        return x(T(this.concat(x(t, n))))
      },
      is: function(t) {
      ...
      find: function(t) {
        ...
        return n = t ? "object" == typeof t ? x(t).filter(function() {
          var t = this;
          return S.some.call(e, function(n) {
      ...
      closest: function(t, n) {
        var e = this[0]
          , r = !1;
        for ("object" == typeof t && (r = x(t)); e && !(r ? r.indexOf(e) >= 0 : W.matches(e, t)); )
          e = e !== n && !i(e) && e.parentNode;
        return x(e)
      },
      parents: function(t) {
        for (var n = [], e = this; e.length > 0; )
          e = x.map(e, function(t) {
            return (t = t.parentNode) && !i(t) && 0 > n.indexOf(t) ? (n.push(t),
              t) : N
          });
        return m(n, t)
      },
      ...
      siblings: function(t) {
        return m(this.map(function(t, n) {
          return $.call(p(n.parentNode), function(t) {
            return t !== n
          })
        }), t)
      },
      ...
      toggle: function(t) {
        return this.each(function() {
          var n = x(this);
          (t === N ? "none" == n.css("display") : t) ? n.show() : n.hide()
        })
      },
      prev: function(t) {
        ...
        return "string" != typeof t || 1 in arguments ? this.each(function(e) {
          if (1 === this.nodeType)
            if (r(t))
              ...
              v(this, t, g(this, n, e, this.getAttribute(t)))
      ...
      css: function(n, e) {
        ...
        var s = "";
        if ("string" == t(n))
          e || 0 === e ? s = a(n) + ":" + f(n, e) : this.each(function() {
            this.style.removeProperty(a(n))
          });
        else
          for (E in n)
            n[E] || 0 === n[E] ? s += a(E) + ":" + f(E, n[E]) + ";" : this.each(function() {
      ...
      toggleClass: function(t, n) {
        return t ? this.each(function(e) {
          ...
          r.split(/\s+/g).forEach(function(t) {
            (n === N ? !i.hasClass(t) : n) ? i.addClass(t) : i.removeClass(t)
          })
        }) : this
      },
      scrollTop: function(t) {
        if (this.length) {
          ...
          return t === N ? n ? this[0].scrollTop : this[0].pageYOffset : this.each(n ? function() {
              this.scrollTop = t
            }
              : function() {
      ...
      scrollLeft: function(t) {
        if (this.length) {
          ...
          return t === N ? n ? this[0].scrollLeft : this[0].pageXOffset : this.each(n ? function() {
              this.scrollLeft = t
            }
              : function() {
      ...
      offsetParent: function() {
        return this.map(function() {
          for (var t = this.offsetParent || L.body; t && !k.test(t.nodeName) && "static" == x(t).css("position"); )
            t = t.offsetParent;
          return t
        })
      }
